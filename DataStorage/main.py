...
def generate_download_url(bucket_name, object_name, expiration=10):
...
# def generate_upload_url(bucket_name, object_name,content_type='image/png', expiration=10):
